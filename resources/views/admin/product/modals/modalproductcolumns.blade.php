    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="form-group form-row filter-row">
                ...
                <div class="col-lg-8">
                    <div class="input text"><input type="text" name="size"
                            class="form-control filter-column f-name" value="{{ $f_size }}" /></div>
                </div>
            </div>
            <div class="form-group form-row filter-row">
                <div class="col-lg-4">
                ...
                <div class="col-lg-8">
                    <div class="input text"><input type="text" name="color"
                            class="form-control filter-column f-name" value="{{ $f_color}}" /></div>
                </div>
            </div>
            </div>
